        ...
        >
          {benefits.map((benefit, index) => (
            <motion.div
              ...
              className={`relative bg-gradient-to-br ${benefit.color} p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 border border-[#2EE59D]/20 overflow-hidden`}
            >
              <motion.div
                initial={{ scale: 0 }}
